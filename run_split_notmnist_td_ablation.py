...
def main(args):
        ...
        for beta in betas:
            for lambd in lambds:    
                ...
                for seed in seeds:
                    ...
                    test_accuracies, test_accuracies_per_task = tdvcl_trainer.train_eval_loop(split_notmnist, model, args, seed)
    ...
    plt.tight_layout()
    plt.savefig('./split_notmnist_td_ablation.png', bbox_inches='tight')
    plt.savefig('./split_notmnist_td_ablation.eps', bbox_inches='tight')
    plt.savefig('./split_notmnist_td_ablation.pdf', bbox_inches='tight')
...
def plot_values(dfs, num_tasks, ax, idx, n_step, title):
    ...
    df_melted.to_csv(f'split_notmnist_td_ablation_final_{n_step}.csv', header=True, index=False)

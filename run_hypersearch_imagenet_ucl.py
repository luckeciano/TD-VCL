...
from modules import UCLBayesianAlexNet64
import numpy as np
import random
...
def main(args):
    ...
    combinations = list(itertools.product(alphas, betas, gammas, kl_betas, lambds_cnn, lambds_mlp)) 
    ...
    for alpha, beta, gamma, kl_beta, lambd_cnn, lambd_mlp in combinations:
        ...
        for seed in seeds:
            ...
            model = UCLBayesianAlexNet64(ft_size, num_heads=10, num_classes=num_classes, lambda_logvar=lambd_cnn, lambda_logvar_mlp=lambd_mlp, alpha=alpha, beta=beta, gamma=gamma)
        ...
        if seed_results:
            ...
            config = (alpha, beta, gamma, kl_beta, lambd_cnn, lambd_mlp)

...
task_id_dict = {1: "'0/1'", 2: "'2/3'", 3: "'4/5'", 4: "'6/7'", 5: "'8/9'"}
...
# figs.savefig('./iclr_split_mnist_multihead_tasks.eps', bbox_inches='tight')
# figs.savefig('./iclr_split_mnist_multihead_tasks.pdf', bbox_inches='tight')
